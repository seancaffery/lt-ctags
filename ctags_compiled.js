...
lt.plugins.ctags.workspace_root = (function workspace_root(path){return cljs.core.first.call(null,cljs.core.filter.call(null,(function (p1__8358_SHARP_){return cljs.core.re_find.call(null,cljs.core.re_pattern.call(null,p1__8358_SHARP_),path);
}),cljs.core.map.call(null,(function (p1__8359_SHARP_){return new cljs.core.Keyword(null,"path","path",1017337751).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,p1__8359_SHARP_));
...
{var lines = cljs.core.remove.call(null,(function (p1__8360_SHARP_){return cljs.core.re_find.call(null,/^!/,p1__8360_SHARP_);
...
return (function (p1__8361_SHARP_){return cljs.core.keyword.call(null,new cljs.core.Keyword(null,"token","token",1124445547).cljs$core$IFn$_invoke$arity$1(p1__8361_SHARP_));
});})(lines,tag_map))
...
return (function (p1__8362_SHARP_){return cljs.core._EQ_.call(null,rel_path,new cljs.core.Keyword(null,"path","path",1017337751).cljs$core$IFn$_invoke$arity$1(p1__8362_SHARP_));
...
lt.plugins.ctags.lookup_tag = (function lookup_tag(ed,p__8363){var map__8365 = p__8363;var map__8365__$1 = ((cljs.core.seq_QMARK_.call(null,map__8365))?cljs.core.apply.call(null,cljs.core.hash_map,map__8365):map__8365);var tag_ns = cljs.core.get.call(null,map__8365__$1,new cljs.core.Keyword(null,"tag-ns","tag-ns",4427582538));var token = cljs.core.get.call(null,map__8365__$1,new cljs.core.Keyword(null,"token","token",1124445547));if(cljs.core.truth_(lt.plugins.ctags.tags_file_exists_QMARK_.call(null,ed)))
...
lt.plugins.ctags.simple_lookup = (function simple_lookup(editor){return lt.plugins.ctags.lookup_tag.call(null,lt.plugins.ctags.this$,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"token","token",1124445547),new cljs.core.Keyword(null,"string","string",4416885635).cljs$core$IFn$_invoke$arity$1(lt.objs.editor.__GT_token.call(null,editor,lt.objs.editor.__GT_cursor.call(null,editor))),new cljs.core.Keyword(null,"namespace","namespace",2266122445),null], null));
});
lt.object.behavior_STAR_.call(null,new cljs.core.Keyword("lt.plugins.ctags","simple-jump-to-definition","lt.plugins.ctags/simple-jump-to-definition",2080531325),new cljs.core.Keyword(null,"reaction","reaction",4441361819),lt.plugins.ctags.simple_lookup,new cljs.core.Keyword(null,"desc","desc",1016984067),"Ctags implementation of jump to definition",new cljs.core.Keyword(null,"triggers","triggers",2516997421),new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword("lt.plugins.ctags","go-to-tag","lt.plugins.ctags/go-to-tag",1177060937),null,new cljs.core.Keyword(null,"editor.jump-to-definition-at-cursor!","editor.jump-to-definition-at-cursor!",4501637705),null], null), null));
